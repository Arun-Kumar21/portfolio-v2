...
const About = () => {
  return (
    ...
    >
      <div className="p-2 sm:p-4 lg:px-28 mx-auto flex flex-col lg:flex-row lg:gap-x-4">
        ...
        <div className="w-full lg:w-1/2 h-full lg:flex flex-col items-center justify-center md:mt-[25vh]">
          <h1 className="text-[#89897F] h-full text-3xl lg:text-5xl">
            I am a full-stack developer with a passion for creating beautiful
            and functional websites.
          </h1>

          <h1 className="text-[#89897F] h-full text-3xl lg:text-5xl mt-4">
